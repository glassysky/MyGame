...
var bulletList = new Array(
        {startAngle:-90,angle:20,step:10,speed:10,count:1},//1发
        {startAngle:-20,angle:20,step:10,speed:10,count:3},//3发
        {startAngle:-40,angle:20,step:10,speed:10,count:5},//5发
        {startAngle:0,angle:20,step:10,speed:10,count:18},//环发
        {startAngle:180,angle:20,step:50,speed:10,count:1},//1发
        {startAngle:160,angle:20,step:50,speed:10,count:3},//3发
        {startAngle:140,angle:20,step:50,speed:10,count:5}//5发
);
...
function gameInit(result){
    ...
    addChild(gameLayer);
    gameLayer.graphics.drawRect(1,"#000000",[0,0,400,800],true,"#000000");
